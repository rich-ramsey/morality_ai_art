...
This file builds some models for Exp1 in the morality aesthetics project.
...
maybe try with broader priors, as the above model worked nicely. 
And broader priors might be more appropriate for a weakly informative approach.

## bf.2 - full model (but with broader priors) ##
...
```{r}
# (just the understanding dv for now to take a look)
pp_bf.2 <- pp_check(bf.2, ndraws = 100, resp = "use")
pp_bf.2
```
...
# save it
ggsave ("exp1/figures/b_chains.jpeg",
        width = 8, height = 6)
```
...
# save it
ggsave ("exp1/figures/sd_chains.jpeg",
        width = 8, height = 6)
```
...
bf_neff <- mcmc_plot(bf.2, type = "neff")
bf_neff
# 
bf_rhat <- mcmc_plot(bf.2, type = "rhat")
bf_rhat
# 
